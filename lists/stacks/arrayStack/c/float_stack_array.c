...
#include <stdio.h>
#include <stdlib.h>
#include "include/float_stack_array.h"
...
initialize_stack(int size) 
{
    ...
    stack->size  = size;
    stack->index = 0;
    stack->stack = (double *) calloc(size, sizeof(double));
...
// ----------------------------------------------------------------------------
int
push(double value, struct array_stack *stack)
{
...
// ----------------------------------------------------------------------------
int
pop(struct array_stack *stack, double *pvalue)
{
    if (is_empty(stack) == 1) {
...
main(int argc, char **argv)
{
    ...
    pop(stack, &pvalue);
    printf("Popped %10.3f from the stack\n", pvalue);
    print_stack_status(stack);
